...
def validate_url(url):
    ...
    elif re.match(r'^\s*$', url):
        st.error ("No URL provided.")
    elif url.startswith("javascript:void(0);"):
        st.error ("Not a URL.")
    elif url.startswith("mailto:"):
        st.error ("Email link, not a URL.")
    elif url.startswith("ftp://"):
        st.error ("Uses an unsupported protocol (FTP).")
...
def main():
    #giving a title
    st.markdown("<h1 style='text-align: center;'>Phishing Detection URL via Machine Learning</h1>", 
    ...
    st.write("<p style='text-align: center;'>Have any questions or need help? Feel free to reach out to me!</p>", unsafe_allow_html=True)
    st.write("<p style='text-align: center;'>Email: <a href='mailto:asrul.aizat123@gmail.com'>asrul.aizat123@gmail.com</a></p>", unsafe_allow_html=True)
    st.write("<p style='text-align: center;'>Phone: +017-5888464</p>", unsafe_allow_html=True)
